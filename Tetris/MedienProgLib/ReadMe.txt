========================================================================
    STATISCHE BIBLIOTHEK: MedienProgLib-Projektübersicht
========================================================================

Dieses MedienProgLib-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Es wurden keine Quelldateien als Teil des Projekts erstellt.


MedienProgLib.vcxproj
